...
public class UIStateNormal : UIStateBase
{
	...
	public override void BeginState ()
	{
		...
		UIEventHandler.OnStartIntroPanel += OnStartIntroPanel;
		UIEventHandler.OnOpenTravelPanel -= OnOpenTravelPanel;
		UIEventHandler.OnOpenTravelPanel += OnOpenTravelPanel;
	}
	...
	public void OnOpenTravelPanel()
	{
		EndState();
		SM.State = new UIStateTravel(SM);
	}
...
public class UIStateTravel : UIStateBase
{
	public UIStateTravel(UIStateMachine sm)
	{
		SM = sm;
		BeginState();
	}
